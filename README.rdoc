...
== Build Status {<img src="https://secure.travis-ci.org/endel/rest-client.png"/>}[http://travis-ci.org/endel/rest-client]

Some tests isn't passing in Ruby 1.9 and Ruby 1.8. Pull requests are welcome.

== Dependency Status {<img src="https://gemnasium.com/endel/rest-client.png?travis"/>}[https://gemnasium.com/endel/rest-client]
