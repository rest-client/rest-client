...
For the POST request, you can add query parameters to the URL like this:

  RestClient.post 'http://example.com/resource', payload, :params => {:foo => 'bar', :baz => 'qux'}
  # will POST http://example.com/resource?foo=bar&baz=qux
